...
var determineFinalDepth = function (directions) {
    var destinationX = 0;
    var destinationY = 0;
    var aim = 0;
    directions.forEach(function (direction) {
...
var firstPart = "First part: ".concat(determineDestination(input));
var secondPart = "Second part: ".concat(determineFinalDepth(input));
