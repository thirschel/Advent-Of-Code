...
const inputArr = input.split(',').map(i=>parseInt(i));
const asciiInput = input.split('').map(i=>i.charCodeAt(0));
...
var firstPart = calculateKnotHash(knotList.map(i=>i), inputArr);
var secondPart = calculateKnotHash(knotList.map(i=>i), asciiInput, 64);

console.log(`First Part: ${firstPart.knotList[0]*firstPart.knotList[1]}`);
console.log(`Second Part: ${secondPart.knotHash}`)
