...
var findThreeNumberExpenseIssue = function (expenses) {
    for (var i = 0; i < expenses.length; i++) {
        for (var j = 0; j < expenses.length; j++) {
...
var firstPart = "First part: " + findTwoNumberExpenseIssue(input);
var secondPart = "Second part: " + findThreeNumberExpenseIssue(input);
